...
class SubSubCategoryScreen extends StatefulWidget {
  const SubSubCategoryScreen({super.key, this.categoryTreeModel});
...
class _SubSubCategoryScreenState extends State<SubSubCategoryScreen> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        appBar: AppBarWidget3(text: widget.categoryTreeModel!.name.toString()),
                    ...
                    : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return CategoryList(
                          ...
                          onTapSubCategory: () {
                            Get.to(
                              () => SubCategoryScreen(categoryTreeModel: data),
                              transition: Transition.fade,
                            );
                          },
                        );
