      ...
      children: [
        ...
        Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                widget.product!.isRefundable == false
                    ? SvgPicture.asset(
                        SvgIcon.close,
                    ...
                    : InkWell(
                        onTap: () {
                          setState(() {
                            returnContrller.addItem(
                                ...
                                variation_id:
                                    widget.product!.variationId.toString(),
                                variation_names:
                                    widget.product!.variationNames.toString());
                          });
                        ...
                        child: SvgPicture.asset(
                          returnContrller.checkItem(index: widget.index) == true
                              ? SvgIcon.checkActive
                              : SvgIcon.check,
                          height: 20.h,
                          width: 20.w,
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    setState(() {
                                      if (quantity <
                                          widget.product!.orderQuantity!
                                              .toInt()) {
                                        quantity++;
                                        returnContrller.incrementItem(
                                            index: widget.index);
                                      }
                                    });
                                  },
                                  child: SvgPicture.asset(SvgIcon.cart2,
                                      color: quantity <
                                              widget.product!.orderQuantity!
                                                  .toInt()
                                          ? null
                                          : AppColor.quantityError,
                                      height: 20.h,
                                      width: 20.w),
                                )
                              ],
