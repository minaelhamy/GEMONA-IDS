...
class OTPController extends GetxController {
  ...
  Future<void> verifyOTPWithEmail({
    ...
    isLoading(true);
    try {
      final resonse = await AppServer().httpPost(
        endPoint: ApiList.verifyEmail,
  ...
  Future<void> verifyOTPWithPhone({
    ...
    try {
      final resonse = await AppServer().httpPost(
        endPoint: ApiList.verifyPhone,
        body: {"phone": phone, "country_code": country_code, "token": token},
      );
  ...
  Future<void> verifyOTPWithEmailForForget({
    ...
    try {
      final resonse = await AppServer().httpPost(
        endPoint: ApiList.verifyForgotEmail,
        body: {"email": email, "token": token},
      );
  ...
  Future<void> verifyOTPWithPhoneForForget({
    ...
    try {
      final resonse = await AppServer().httpPost(
        endPoint: ApiList.verifyForgotPhone,
        body: {"phone": phone, "country_code": country_code, "token": token},
      );
  ...
  Future<void> sendOTPWithEmail({required String email}) async {
    try {
      final resonse = await AppServer().httpPost(
        endPoint: ApiList.resendOTPEmail,
        body: {"email": email},
      );
  ...
  Future<void> sendOTPWithPhone({
    ...
    try {
      final resonse = await AppServer().httpPost(
        endPoint: ApiList.resendOTPPhone,
  ...
  Future<void> resendOTPWithEmailForForget({required String email}) async {
    ...
    try {
      final resonse = await AppServer().httpPost(
        endPoint: ApiList.resendForgotOTPEmail,
        body: {"email": email},
      );
  ...
  Future<void> resendOTPWithPhoneForForget({
    ...
    try {
      final resonse = await AppServer().httpPost(
        endPoint: ApiList.resendForgotOTPPhone,
        body: {"phone": phone, "country_code": country_code},
      );
