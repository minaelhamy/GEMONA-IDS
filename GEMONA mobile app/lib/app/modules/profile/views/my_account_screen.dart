                        ...
                        profile.profileMap.isNotEmpty &&
                            ...
                            ? Row(
                              children: [
                                ...
                                TextWidget(
                                  text: '${profile.profileModel!.data!.name}!',
                                  color: AppColor.textColor,
                                  fontSize: 16.sp,
                                  fontWeight: FontWeight.w500,
                                ),
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: AppColor.pinkColor.withOpacity(
                                        0.25,
                                      ),
                              ...
                              Obx(
                                () =>
                                    profile.totalOrdersCountMap.isNotEmpty &&
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: AppColor.orangeColor.withOpacity(
                                        0.25,
                                      ),
                                      offset: const Offset(0, 6),
                                      blurRadius: 15.r,
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: AppColor.returnColor.withOpacity(
                                        0.25,
                                      ),
                                      offset: const Offset(0, 6),
                                      blurRadius: 15.r,
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: AppColor.blueColor1.withOpacity(
                                        0.25,
                                      ),
                                      offset: const Offset(0, 6),
                                      blurRadius: 15.r,
                              ...
                              Obx(
                                () =>
                                    profile.totalWalletBalanceMap.isNotEmpty &&
                  ...
                  Obx(
                    () =>
                        order.orderHistoryList.isNotEmpty &&
                            ...
                            ? ListView.builder(
                              itemCount:
                                  order.orderHistoryList.length > 3
                                      ? 3
                            ...
                            : Center(
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(height: 16.h),
                                  TextWidget(
                                    text: 'ORDER_HISTORY_IS_EMPTY'.tr,
                                    color: AppColor.textColor,
                                    fontSize: 14.sp,
                                    fontWeight: FontWeight.w500,
                                  ),
