...
import 'package:shopperz/utils/helper.dart/currency_formatter.dart';
              ...
              child: Column(
                ...
                children: [
                                          ...
                                          onTap: () {
                                            openEditAddressDialog(
                                              ...
                                              country: showAddressController
                                                  ...
                                                  .country
                                                  .toString(),
                                              countryCode: showAddressController
                                                  .addressList
                                                  .value
                                                  .data![showAddressController
                                                      .selectedAddressIndex
                  ...
                  box.read('isLogedIn') == false
                      ...
                      : Obx(
                          () =>
                              showAddressController.addressList.value.data ==
                                  null
                              ? const SizedBox()
                              : ListView.builder(
                                                    ...
                                                    () =>
                                                        ...
                                                        : AddressCard(
                                                            ...
                                                            email:
                                                                ...
                                                                "",
                                                            streetAddress:
                                                                '${address[index].city.toString() != '' ? '${address[index].city}, ' : ''} ${address[index].state.toString() != '' ? '${address[index].state}, ' : ''} ${address[index].country.toString() != '' ? '${address[index].country}, ' : ''} ${address[index].zipCode.toString() != '' ? address[index].zipCode.toString() : ''}'
                                                                    .replaceAll(
                                                                      ' ',
                                                                      '',
                                                                    ),
                  ...
                  isDelivery == false ? SizedBox() : SizedBox(height: 26.h),
                  isDelivery == false
                      ? const SizedBox()
                      : Row(
                          children: [
                  ...
                  isDelivery == false ? SizedBox(height: 24.h) : SizedBox(),
                  isDelivery == false
                      ? const SizedBox()
                      : Obx(
                          () => Visibility(
                                      ...
                                      children: [
                                        ...
                                        couponController
                                            ...
                                            : TextWidgetWithCurrency(
                                                text:
                                                    '${'You saved'.tr} ${formatPriceWithCurrency(double.parse(couponController.applyCouponModel.value.data?.convertDiscount.toString() ?? "0.0"))}',
                                                color: AppColor.textColor,
                                                fontSize: 12.sp,
                                                fontWeight: FontWeight.w400,
                                              ),
