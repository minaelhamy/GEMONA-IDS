...
ChildrenVariationModel childrenVariationModelFromJson(String str) =>
    ChildrenVariationModel.fromJson(json.decode(str));

String childrenVariationModelToJson(ChildrenVariationModel data) =>
...
class ChildrenVariationModel {
  ...
  factory ChildrenVariationModel.fromJson(Map<String, dynamic> json) =>
      ChildrenVariationModel(
        data: json["data"] == null
            ? []
