  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['order_address'] != null) {
      ...
      json['order_address'].forEach((v) {
        orderAddress!.add(OrderAddress.fromJson(v));
      });
    }
    outletAddress =
        json['outlet_address'] != null
...
class OrderProducts {
  ...
  OrderProducts.fromJson(Map<String, dynamic> json) {
    ...
    productTax =
        json["product_tax"] == null
            ? []
            : List<ProductTax>.from(
              json["product_tax"]!.map((x) => ProductTax.fromJson(x)),
            );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['variation_id'] =
        data['product_tax'] =
            productTax == null
                ? []
                : List<dynamic>.from(productTax!.map((x) => x.toJson()));
    return data;
  }
}
...
class ProductTax {
  ...
  ProductTax({this.taxName, this.taxRate});

  factory ProductTax.fromJson(Map<String, dynamic> json) =>
      ProductTax(taxName: json["tax_name"], taxRate: json["tax_rate"]);

  Map<String, dynamic> toJson() => {"tax_name": taxName, "tax_rate": taxRate};
}
