          ...
          children: [
            ...
            productDetailsController.productModel.value.data!.videos!.isEmpty ||
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final rawUrl = productDetailsController
                          .productModel
                          .value
                          .data!
                          .videos![index]
                      ...
                      final embedUrl = convertToEmbedUrl(rawUrl);
                    ...
                    productDetailsController
                        ...
                        ? Center(
                            child: InkWell(
                              onTap: () {
                                setState(() {
                                  productDetailsController.reviewLimit.value++;
...
class ShippingReturnView extends StatelessWidget {
  const ShippingReturnView({super.key});
