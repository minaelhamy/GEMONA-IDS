...
class LanguageController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:settings', only: ['index', 'store', 'update', 'show', 'destroy', 'fileList', 'fileText', 'fileTextStore']),
        ];
    }
